...
1551  01d0               L326:
1552                     ; 415     return ((uint16_t)temph);
1554  01d0 1e04          	ldw	x,(OFST-1,sp)
1557  01d2 5b05          	addw	sp,#5
1558  01d4 81            	ret
1604                     ; 427 void ADC1_AWDChannelConfig(ADC1_Channel_TypeDef Channel, FunctionalState NewState)
1604                     ; 428 {
1605                     	switch	.text
1606  01d5               _ADC1_AWDChannelConfig:
1608  01d5 89            	pushw	x
1609       00000000      OFST:	set	0
1612                     ; 430     assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1614                     ; 431     assert_param(IS_ADC1_CHANNEL_OK(Channel));
1616                     ; 433     if (Channel < (uint8_t)8)
1618  01d6 9e            	ld	a,xh
1619  01d7 a108          	cp	a,#8
1620  01d9 242e          	jruge	L746
1621                     ; 435         if (NewState != DISABLE)
1623  01db 9f            	ld	a,xl
1624  01dc 4d            	tnz	a
1625  01dd 2714          	jreq	L156
1626                     ; 437             ADC1->AWCRL |= (uint8_t)((uint8_t)1 << Channel);
...
1643  01f3               L156:
1644                     ; 441             ADC1->AWCRL &= (uint8_t)~(uint8_t)((uint8_t)1 << Channel);
...
1661  0209               L746:
1662                     ; 446         if (NewState != DISABLE)
1664  0209 0d02          	tnz	(OFST+2,sp)
1665  020b 2717          	jreq	L756
1666                     ; 448             ADC1->AWCRH |= (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8));
...
1684  0224               L756:
1685                     ; 452             ADC1->AWCRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (uint8_t)(Channel - (uint8_t)8));
...
1706  023a 85            	popw	x
1707  023b 81            	ret
1742                     ; 463 void ADC1_SetHighThreshold(uint16_t Threshold)
1742                     ; 464 {
1743                     	switch	.text
1744  023c               _ADC1_SetHighThreshold:
1746  023c 89            	pushw	x
1747       00000000      OFST:	set	0
1750                     ; 465     ADC1->HTRH = (uint8_t)(Threshold >> (uint8_t)2);
1752  023d 54            	srlw	x
1753  023e 54            	srlw	x
1754  023f 9f            	ld	a,xl
1755  0240 c75408        	ld	21512,a
1756                     ; 466     ADC1->HTRL = (uint8_t)Threshold;
1758  0243 7b02          	ld	a,(OFST+2,sp)
1759  0245 c75409        	ld	21513,a
1760                     ; 467 }
1763  0248 85            	popw	x
1764  0249 81            	ret
1799                     ; 475 void ADC1_SetLowThreshold(uint16_t Threshold)
1799                     ; 476 {
1800                     	switch	.text
1801  024a               _ADC1_SetLowThreshold:
1805                     ; 477     ADC1->LTRL = (uint8_t)Threshold;
1807  024a 9f            	ld	a,xl
1808  024b c7540b        	ld	21515,a
1809                     ; 478     ADC1->LTRH = (uint8_t)(Threshold >> (uint8_t)2);
1811  024e 54            	srlw	x
1812  024f 54            	srlw	x
...
1815                     ; 479 }
1818  0254 81            	ret
1871                     ; 488 uint16_t ADC1_GetBufferValue(uint8_t Buffer)
1871                     ; 489 {
1872                     	switch	.text
...
1880                     ; 491     uint16_t temph = 0;
1882                     ; 492     uint8_t templ = 0;
1884                     ; 495     assert_param(IS_ADC1_BUFFER_OK(Buffer));
1886                     ; 497     if ((ADC1->CR2 & ADC1_CR2_ALIGN) != 0) /* Right alignment */
1888  0258 c65402        	ld	a,21506
1889  025b a508          	bcp	a,#8
1890  025d 271f          	jreq	L547
1891                     ; 500         templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
...
1899                     ; 502         temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
...
1909                     ; 504         temph = (uint16_t)(templ | (uint16_t)(temph << (uint8_t)8));
...
1917  027e               L547:
1918                     ; 509         temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
...
1928                     ; 511         templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
...
1936                     ; 513         temph = (uint16_t)((uint16_t)((uint16_t)templ << 6) | (uint16_t)(temph << 8));
...
1952  02a9               L747:
1953                     ; 516     return ((uint16_t)temph);
1955  02a9 1e04          	ldw	x,(OFST-1,sp)
1958  02ab 5b06          	addw	sp,#6
1959  02ad 81            	ret
2025                     ; 526 FlagStatus ADC1_GetAWDChannelStatus(ADC1_Channel_TypeDef Channel)
2025                     ; 527 {
2026                     	switch	.text
...
2034                     ; 528     uint8_t status = 0;
2036                     ; 531     assert_param(IS_ADC1_CHANNEL_OK(Channel));
2038                     ; 533     if (Channel < (uint8_t)8)
2040  02b0 a108          	cp	a,#8
2041  02b2 2412          	jruge	L3001
2042                     ; 535         status = (uint8_t)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << Channel));
2044  02b4 5f            	clrw	x
...
2058  02c6               L3001:
2059                     ; 539         status = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8)));
...
2075  02da               L5001:
2076                     ; 542     return ((FlagStatus)status);
2078  02da 7b01          	ld	a,(OFST+0,sp)
2081  02dc 85            	popw	x
2082  02dd 81            	ret
2240                     ; 551 FlagStatus ADC1_GetFlagStatus(ADC1_Flag_TypeDef Flag)
2240                     ; 552 {
2241                     	switch	.text
...
2284                     ; 570             flagstatus = (uint8_t)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
...
2301  0317               L3011:
2302                     ; 574             flagstatus = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
2319  032d               L1011:
2320                     ; 579         flagstatus = (uint8_t)(ADC1->CSR & Flag);
2322  032d c65400        	ld	a,21504
2323  0330 1402          	and	a,(OFST+1,sp)
2324  0332 6b01          	ld	(OFST+0,sp),a
2325  0334               L7701:
2326                     ; 581     return ((FlagStatus)flagstatus);
2328  0334 7b01          	ld	a,(OFST+0,sp)
2331  0336 85            	popw	x
2332  0337 81            	ret
2376                     ; 591 void ADC1_ClearFlag(ADC1_Flag_TypeDef Flag)
2376                     ; 592 {
2377                     	switch	.text
...
2416                     ; 609             ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
...
2434  0370               L1411:
2435                     ; 613             ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
2453  0388               L7311:
2454                     ; 618         ADC1->CSR &= (uint8_t) (~Flag);
...
2464  0391 85            	popw	x
2465  0392 81            	ret
2520                     ; 640 ITStatus ADC1_GetITStatus(ADC1_IT_TypeDef ITPendingBit)
2520                     ; 641 {
2521                     	switch	.text
...
2529                     ; 642     ITStatus itstatus = RESET;
2531                     ; 643     uint8_t temp = 0;
2533                     ; 646     assert_param(IS_ADC1_ITPENDINGBIT_OK(ITPendingBit));
2535                     ; 648     if (((uint16_t)ITPendingBit & 0xF0) == 0x10)
...
2543                     ; 651         temp = (uint8_t)((uint16_t)ITPendingBit & 0x0F);
...
2553                     ; 654             itstatus = (ITStatus)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
...
2570  03bf               L7711:
2571                     ; 658             itstatus = (ITStatus)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
2588  03d5               L5711:
2589                     ; 663         itstatus = (ITStatus)(ADC1->CSR & (uint8_t)ITPendingBit);
2591  03d5 c65400        	ld	a,21504
2592  03d8 1403          	and	a,(OFST+2,sp)
2593  03da 6b01          	ld	(OFST+0,sp),a
2594  03dc               L3021:
2595                     ; 665     return ((ITStatus)itstatus);
2597  03dc 7b01          	ld	a,(OFST+0,sp)
2600  03de 5b03          	addw	sp,#3
2601  03e0 81            	ret
2646                     ; 687 void ADC1_ClearITPendingBit(ADC1_IT_TypeDef ITPendingBit)
2646                     ; 688 {
2647                     	switch	.text
...
2655                     ; 689     uint8_t temp = 0;
2657                     ; 692     assert_param(IS_ADC1_ITPENDINGBIT_OK(ITPendingBit));
2659                     ; 694     if (((uint16_t)ITPendingBit & 0xF0) == 0x10)
...
2667                     ; 697         temp = (uint8_t)((uint16_t)ITPendingBit & 0x0F);
...
2677                     ; 700             ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
...
2695  040f               L1321:
2696                     ; 704             ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
2714  0427               L7221:
2715                     ; 709         ADC1->CSR &= (uint8_t)((uint16_t)~(uint16_t)ITPendingBit);
